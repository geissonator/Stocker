...
public class DataFactory {
    ...
    public static KeyStatisticsData getKeyStatisticsData(String i_stockSymbol) {
    ...
    public static StockerGlobalData getStockerInfoData() {
        
        // Nice and simple right now since we only support the 
        // psv type.
        return new StockerGlobalDataPsv();
    }
